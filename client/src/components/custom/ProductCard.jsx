...
const ProductCard=({name="Product Title", 
    price=2000, 
    rating=2.9, 
    image={url:"https://images.pexels.com/photos/321452/pexels-photo-321452.jpeg?auto=compress&cs=tinysrgb&w=600", id:"322dadaf"},
    })=>{
    return(
        <div className="relative border w-fit overflow-clip grid z-1 hower:shadow-md rounded-2xl">
